...
export default function Article() {
  return (
    <div className="order-1 w-full text-gray-400 lg:order-2 lg:w-6/12">
      <p>
      ...
      <img src={BlogImg} alt="" className="py-5" />
      <h4 className="pb-5 text-2xl font-semibold text-black">
      ...
      <h4 className="py-5 text-2xl font-semibold text-black">
      ...
      <p>
        And if she hasn’t been rewritten, then they are still using her. On her
        ...
        that was left from its origin would be the word and the Little Blind
      ...
      <p>
        ...
        their place and supplies it with the necessary regelialia.And if she
